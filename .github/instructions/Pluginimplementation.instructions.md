...
# Instruction Summary
  1. [Inter-Plugin Communication](https://github.com/rdkcentral/entservices-account/blob/develop/.github/instructions/Pluginimplementation.instructions.md#inter-plugin-communication)
  2. [On-Demand Plugin Interface Acquisition](https://github.com/rdkcentral/entservices-account/blob/develop/.github/instructions/Pluginimplementation.instructions.md#on-demand-plugin-interface-acquisition)
...
Telemetry Plugin accessing UserSettings(via COM-RPC) through the IShell Interface API **QueryInterfaceByCallsign()** exposed for each Plugin - (Refer https://github.com/rdkcentral/entservices-telemetry/blob/develop/plugin/TelemetryImplementation.cpp#L160 )
