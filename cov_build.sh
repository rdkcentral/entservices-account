...
############################
# Build entservices-account
echo "building entservices-account"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-account \
-DUSE_THUNDER_R4=ON \
...
-DENABLE_TELEMETRY_LOGGING -DDISABLE_SECURITY_TOKEN -DHAS_RBUS -DTHUNDER_VERSION=4 -DTHUNDER_VERSION_MAJOR=4 -DTHUNDER_VERSION_MINOR=4" \
